...
public class HomeTask0218 {
    ...
    public static int searchInAscendingArray(int num, int[] a, int left, int right, boolean showFirst){
        if (left > right) {
            System.out.println("Указан несуществующий диапазон");
            return -1;
        }
        ...
        return searchInAscendingArray(num, a, left, right,showFirst);
    }

    public static int searchInDescendingArray(int num, int[] a, int left, int right, boolean showFirst){
        ...
        return searchInDescendingArray(num, a, left, right, showFirst);
